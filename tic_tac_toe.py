# Tic-Tac-Toe Game using Click-To-Play UI in python.
...
def disable_all_buttons():
    # Configuration state of all buttons changed to disabled.
...
# Function to display X or O when button is clicked:
def b_click(b):
